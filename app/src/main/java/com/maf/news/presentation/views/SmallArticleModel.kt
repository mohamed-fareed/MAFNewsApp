...
import kotlinx.android.synthetic.main.layout_small_article.view.*

@ModelView(autoLayout = ModelView.Size.MATCH_WIDTH_WRAP_HEIGHT)
class SmallArticleModel @JvmOverloads constructor(
    context: Context,
    ...
    init {
        ...
        inflater.inflate(R.layout.layout_small_article, this, true)
    ...
    fun setArticleData(article: ArticleViewModel) {
        ...
        tv_article_desc.text = article.description
